...
void	square_info_set(int	*elem[max_params])
{
	int		*square_info;
...
void	sphere_info_set(int	*elem[max_params])
{
	int	*sphere_info;
...
void	triangle_info_set(int	*elem[max_params])
{
	int		*triangle_info;
...
void	cylinder_info_set(int	*elem[max_params])
{
	int		*cylinder_info;
...
void	plane_info_set(int	*elem[max_params])
{
	int		*plane_info;
...
void	camera_info_set(int	*elem[max_params])
{
	int		*camera_info;
...
void	res_info_set(int	*elem[max_params])
{
	int		*res_info;
...
void	amb_info_set(int	*elem[max_params])
{
	int		*amb_info;
...
void	light_info_set(int	*elem[max_params])
{
	int		*light_info;
...
void	rot_info_set(int	*elem[max_params])
{
	int		*rot_info;
...
void	tran_info_set(int	*elem[max_params])
{
	int		*tran_info;
